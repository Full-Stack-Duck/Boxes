...
export function PesquisarEstoque() {
    return (
        <section className="flex flex-col items-center justify-center w-full">
            <h1 className="font-quicksand font-bold text-2xl py-3 border-y w-full px-7 lg:hidden lg:p-4">Estoque</h1>
            <div className='flex flex-col bg-white px-7 my-1 w-full font-quicksand font-semibold border-b lg:border lg:border-light-purple lg:rounded-xl lg:p-4 lg:m-0'>
    
                <div className="flex pt-3 pb-4 w-full">
                ...
                <div className="lg:flex lg:gap-20">
                    <div className="lg:w-1/2">
                        <article className="flex-row text-sm items-center">
                            <form action="" className='w-full flex'>
                                <label className='text-purple-medium w-1/2 mt-1.5' htmlFor="">ESCOLHA TIPO:</label>
                                <select className="border rounded w-full h-8 text-purple-light border-purple-light font-nunito my-1.5" name="" id="">
                            ...
                            <form action="" className='w-full flex'>
                                <label className='text-purple-medium w-1/2 mt-1.5' htmlFor="">ESCOLHA ITEM:</label>
                                <select className="border rounded w-full h-8 text-purple-light  border-purple-light font-nunito my-1.5" name="" id="">
                                    <option className="text-xs" value="valor0">Selecione o tipo</option>
                                    <option value="valor1">Valor 1</option>
                                    <option value="valor2">Valor 2</option>
                    ...
                    <div className="lg:w-1/2">
                        <div className='pt-10 lg:px-4 lg:pt-0'>
