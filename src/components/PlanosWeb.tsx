...
export function Planos(){
    return(
        <section className="flex flex-col bg-white text-gray-purplegray font-quicksand px-6 py-8">
            <article className="text-center">
                <h2 className="font-playfair font-bold text-3xl tracking-widest pb-6">PLANOS</h2>
