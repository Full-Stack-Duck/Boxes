        ...
        <section className="flex flex-col bg-white text-gray-purplegray font-quicksand px-6 py-8 lg:px-32">
            ...
            <div className="lg:flex lg:justify-around">
                <div className="flex justify-center">
                    <div className="bg-purple-dark rounded text-center text-white mb-5 h-60 w-60 justify-items-center hover:shadow-md hover:shadow-pink-medium hover:scale-110 hover:duration-500">
                        ...
                        <Link to="/cadastro" className="px-7 py-1.5 border rounded-2xl font-semibold tracking-widest text-sm hover:bg-purple-medium">Assine agora!</Link>
                    </div>
                </div>
                <div className="flex justify-center">
                    <div className="bg-purple-dark rounded text-center text-white mb-5 h-60 w-60 justify-items-center shadow-lg shadow-pink-medium hover:shadow-xl hover:shadow-pink-medium relative hover:scale-110 hover:duration-500">
                        ...
                        <Link to="/cadastro" className="px-7 py-1.5 bg-purple-medium border rounded-2xl font-semibold tracking-widest text-sm hover:bg-purple-400">Assine agora!</Link>
                ...
                <div className="flex justify-center">
                    <div className="bg-purple-dark rounded text-center text-white h-60 w-60 justify-items-center hover:shadow-md hover:shadow-pink-medium hover:scale-110 hover:duration-500">
