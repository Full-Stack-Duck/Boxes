       ...
       <footer className="font-quicksand font-medium flex flex-col px-7 bg-purple-dark text-purple-light lg:px-32 lg:flex-row lg:pb-4">
        <div className="xl:w-1/3 lg:w-1/4">
            ...
            <nav className="flex flex-col justify-center">
                <a href="#" className={styles.aFooter}><span className="material-symbols-outlined">chevron_right</span>Cadastre-se</a>
                <a href="#" className={styles.aFooter}><span className="material-symbols-outlined">chevron_right</span>Login</a>
                <a href="#" className={styles.aFooter}><span className="material-symbols-outlined">chevron_right</span>Contatos</a>
            </nav>
        </div>

        <div className="xl:w-1/3 lg:w-2/4 lg:px-10 lg:pt-3 xl:mx-16 xl:px-0">
            <nav className="flex flex-col justify-center">
