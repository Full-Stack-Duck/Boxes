...
export function PesquisarDespesas() {
...
function filtrarProdutosPor(
  ...
  return (
    <section className="w-full flex flex-col justify-center border-y bg-white font-quicksand font-semibold lg:border-purple-light lg:border lg:rounded-xl lg:flex-row ">
      <div className="flex-col items-center px-7 w-full lg:w-1/2">
        <div>
            <h3 className="text-lg py-2 font-bold">Pesquisar Despesas</h3>
      ...
      <div className="lg:w-1/2 flex-col lg:pt-10">
        <div className="">
          <ResultadoPadrao />
        </div>
      </div>
