...
export function Beneficios(){
    return(
        <section className="flex flex-col bg-pink-light text-gray-purplegray font-quicksand px-6 py-8 lg:px-32">
            <article className="text-center">
                <h2 className="font-playfair font-bold text-3xl tracking-widest pb-6 lg:text-4xl">BENEFÍCIOS</h2>
                <p className="text-gray-purplegray font-semibold pb-8 lg:text-lg">Veja como o sistema de gestão <span className="font-viga text-lg">Boxes</span> irá ajudar você e sua empresa.</p>
            </article>
            <div className="lg:flex lg:flex-wrap">
                <div className="flex justify-center lg:w-1/2 lg:justify-end lg:pr-8">
                    <div className="bg-white rounded border border-pink-soft text-center my-4 h-60 max-w-xs">
                ...
                <div className="flex justify-center lg:w-1/2 lg:justify-start lg:pl-8">
                    <div className="bg-white rounded border border-pink-soft text-center my-4 h-60 max-w-xs">
